...
**We do not collect any data.** The App does not have servers, does not use analytics, does not show ads, and does not contain third-party tracking SDKs.
...
The App is not directed at children under 13, and it does not knowingly collect data from them.
...
**Hiçbir veri toplamıyoruz.** Uygulamanın sunucusu yoktur; analiz kullanmaz, reklam göstermez ve üçüncü taraf takip SDK'sı içermez.
...
Verilerinizi asla satmıyor, kiralamıyor veya kimseyle paylaşmıyoruz.

### Çocuklar

Uygulama 13 yaş altındaki çocuklara yönelik değildir ve onlardan bilinçli olarak veri toplamaz.
